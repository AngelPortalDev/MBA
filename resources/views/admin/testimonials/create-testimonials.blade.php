            ...
            <div class="offset-xl-3 col-xl-6 col-12">
                ...
                <form class="TestimonialForm" novalidate enctype="multipart/form-data">
                            ...
                            <div class="d-lg-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center mb-4 mb-lg-0">
                                    <div class="me-2 position-relative">
                                        <img class="avatar-xl rounded-circle border border-4 border-white imageAdminPreview" src="{{Storage::url('studentDocs/student-profile-photo.png')}}">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <h4 class="mb-4 border-bottom pb-2">Create Testimonials</h4>
                            <!-- row -->
                            <div class="row gx-3">
                                <!-- input -->
                                ...
                                <div class="col-md-12">
                                    <label for="customerNotes" class="form-label">
                                        ...
                                        <small>(Maximum 100 words)</small>
                                    </label>
                                    <textarea class="form-control" id="feedback" rows="5" placeholder="Write here..."  name="feedback" required=""></textarea>
                    ...
                    <div class="d-flex justify-content-end">
                        <!-- buttons -->
                        <button class="btn btn-primary  me-2 testimonalsCreate" type="submit">Add Now</button>

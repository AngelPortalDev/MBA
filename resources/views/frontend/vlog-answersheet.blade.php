                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body py-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="fw-bold mb-0 color-blue ">Vlog (40%) <span
                                        class="fs-6 fw-semibold">Award in Public Speaking and Presentation Skills</span>
                                </h3>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="lh-1">
                                        <h4 class="mb-1 mobileviewtext"> Student Name: <span class="color-blue">Kathryn Jones</span>
                                        </h4>
                                    </div>
                                </div>
                                <div>
                                    <a href="#" class="btn btn-outline-primary mobileViewButton">Back</a>
                                </div>
                            </div>
                        ...
                        <section class="container px-4 pt-4">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-12 mb-3">
                                    <p> <strong>Instructions:</strong> A vlog video (short for "video blog") is a type of video content where an individual shares their personal experiences, thoughts, or daily activities. It’s a form of self-expression and communication often used by content creators to connect with their audience(10%).</p>
                                </div>
                                <hr>

                                <div class="col-md-12 mb-5">
                                    <label for="textarea-input" class="form-label">
                                        <h4 class="color-blue mb-0"> 
                                           Vlog Video</h4>
                                    </label>
                                    <p class="fw-bold">Question: You will then need to source and interview the pseudo candidate, record the interview in video format and submit it. [40 Marks]</p>

                                    <input type="hidden" name="question_id" id="question_id" value="1">
                                    <input type="hidden" name="Mock Interview_mark" id="Mock Interview_mark" value="15">
                                    <h5>Answer:</h5>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-3 col-12">
                                            <div class="d-flex justify-content-center align-items-center rounded border-white border rounded-3 bg-cover" style="background-image:url({{asset('frontend/images/course/mock-interview-thumbnail-01.png') }});height:155px;">
                                                ...
                                                <a class="icon-shape rounded-circle btn-play icon-xl bg-blue" data-bs-toggle="modal" data-bs-target="#exampleModal-2" href="#">
                                                    <i class="bi color-green fw-bold bi-play fs-3"></i>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-12 mt-3 mb-3">
                                            <div class="color-blue d-flex align-items-end">
                                                <div class="col-md-4 col-lg-2">
                                                    <h5 class="me-3 ">Marks: <span>(Out of 40)</span></h5>
                                                    <input type="number" class="form-control" placeholder="Give Marks">
                                                </div>

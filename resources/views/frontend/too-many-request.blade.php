        ...
        <div class="container">
            <div class="row align-items-center text-center text-md-left">
                ...
                <div class="col-md-6 order-1 order-md-2">
                    <img src="{{ asset('frontend/images/toomanyrequest-01.png') }}" alt="Too Many Requests" class="img-fluid rounded-3">
                </div>
                ...
                <div class="col-md-6 order-2 order-md-1 mt-md-3 mt-0">
                    ...
                    <p class="mb-4 summary">
                        If the issue persists or you need further assistance, feel free to contact us at <a href="mailto:support@eascencia.mt" class="text-decoration-none">support@eascencia.mt</a>
                    </p>

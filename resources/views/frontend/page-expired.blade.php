        ...
        <div class="container">
            <div class="row align-items-center text-center text-md-left">
                ...
                <div class="col-md-6 order-1 order-md-2">
                    <img src="{{ asset('frontend/images/PageExpired_new-01.png') }}" alt="Page Expired" class="img-fluid rounded-3">
                </div>
                ...
                <div class="col-md-6 order-2 order-md-1 mt-md-3 mt-0">
                    ...
                    <p class="mb-4 summary">
                        If you believe this is an error or need assistance, feel free to contact us at <a href="mailto:support@eascencia.mt" class="text-decoration-none">support@eascencia.mt</a>
                    </p>

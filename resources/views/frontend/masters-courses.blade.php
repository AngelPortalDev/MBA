        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div>
                        <h1 class="text-white mb-1 display-4 color-green">Masters Courses</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="course-category-tabs-main pt-5 pb-3 pb-lg-2">
        ...
        <div class="container mb-lg-8">
            ...
            <div class="row row-gap-3">
                ...
                @php
                $master =
                getData('course_master',['course_title','id','selling_price','ects','course_final_price','course_old_price','course_thumbnail_file','status','temp_count'],['category_id'=>'4'],'',DB::raw('IFNULL(published_on, "NULL")'),'asc');
                ...
                @endforeach
                @else
                <img src="{{ asset('frontend/images/ComingSoon.png') }}" alt="Masters" style="width:auto;height:auto" loading="lazy"/>
                @endif

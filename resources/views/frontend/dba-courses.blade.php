        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div>
                        <h1 class="text-white mb-1 display-4 color-green">DBA Courses</h1>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between mt-1">
                                                    ...
                                                    @if($promoCode)
                                                        ...
                                                        <span class="badge badge-success text-primary" style="padding: 2px 4px"><span style="user-select: none">PROMO:</span> <span class="fw-bold">{{$promoCode}}</span></span>
                                                        </small>
                                                    @endif
                                                </div>
                                                {{-- <div class="lh-1 mt-3">
                                                        ...
                                                        @elseif (Auth::check() && Auth::user()->role =='user')
                                                            ...
                                                            @if(Auth::user()->apply_dba == 'Yes')
                                                                @if($doc_verified[0]->identity_is_approved = "Approved" && $doc_verified[0]->edu_is_approved == "Approved" && $doc_verified[0]->resume_file != ''  && $doc_verified[0]->english_score >= 10 && $doc_verified[0]->proposal_is_approved == 'Approved') 
                                                                    ...
                                                                    @endif
                                                                @else
                                                                    <a href="{{route('student-document-verification')}}"><button class="buy-now">Buy Now</button>
                                                                @endif   
                                                            @else
                                                                @if (isset($isPaid) && is_numeric($isPaid) &&  $isPaid == 0)
                                                                <div class="d-flex">

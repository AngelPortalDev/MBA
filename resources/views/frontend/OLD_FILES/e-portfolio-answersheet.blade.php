                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body py-3">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="fw-bold mb-0 color-blue ">E-Portfolio 
                                    <span class="fs-6 fw-semibold">Award in Recruitment and Employee Selection</span>
                                </h3>
